...
define( 'WPCACHEHOME', '/home/mztribute/public_html/tribaltix.com/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'i1306013_wp7');

/** MySQL database username */
define('DB_USER', 'i1306013_wp7');

/** MySQL database password */
define('DB_PASSWORD', 'X[SHLul1b1Ya6z#Pds(92#(8');
